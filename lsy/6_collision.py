...
#배경 이미지 불러오기
background = pygame.image.load("C:/Users/lsy23/OneDrive/바탕 화면/Phython/Python/lsy/background.png")

#캐릭터(스프라이트) 불러오기
character = pygame.image.load("C:/Users/lsy23/OneDrive/바탕 화면/Phython/Python/lsy/character.png")
...
# 적 enemy 캐릭터
enemy = pygame.image.load("C:/Users/lsy23/OneDrive/바탕 화면/PythonWorkspace/pygame_basic/enemy.png")
...
# 캐릭터가 100 만큼 이동을 해야함
# 10 fps : 1초 동안에 10번 동작 -> 1번에 몇 만큼 이동? 10 만큼
